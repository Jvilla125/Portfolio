            ...
            <div class="card mx-auto" style={{ width: "30rem" }}>
                <div class="card-body ">
                    ...
                    <p class="card-text">Hello, I am a full stack Software Engineer who is super eager to learn and is always looking to take on new challenges. <br /> <br />
                        ...
                        with a Commerical General Contractor. <br/><br/>
                        <u>2020-2022</u> <br/>
                        ...
                        During my time at community college and university I took intro to C++ and python courses but never really pursued it as a major. I knew that it was related to my major
                        and that I wanted to <br/><br/>
                        <u>2022+</u> <br/>
                ...
                <div class="collapse" id="collapseExample">
                    <div class="card card-body">
                        <ul >
                            <li>I graduated from University of California, Santa Cruz in 2020 with a B.A. in Mathematics.</li>
                            <li></li>
